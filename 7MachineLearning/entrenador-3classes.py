...
def create_model( image_height, image_width, channels, num_labels):
    ...
    #filters = [16, 16, 8, 8] #HEIGHT*41*16 = 196.144 activaciones, 196144 * 4 = 784 KB, and flattern OK
    filters = [12, 12, 8, 8] 
...
if __name__ == "__main__":
    ...
    HEIGHT = 149
    model_CNN = create_model( image_height=HEIGHT,image_width=41,channels=1,num_labels=len(label_names) )
    ...
    #model_CNN.save( "speech_commands_HEIGHTx41.h5")
    model_CNN.save( "speech_commands_149x41.h5")
...
with open("speech_commands_149x41.tflite","wb") as f:
    f.write(tflite_model)

#print("\nSaved:","speech_commands_149x41.tflite")

# --------------------------------------------------
# LOAD TFLITE MODEL
# --------------------------------------------------
interpreter = tf.lite.Interpreter(model_path="speech_commands_149x41.tflite")
