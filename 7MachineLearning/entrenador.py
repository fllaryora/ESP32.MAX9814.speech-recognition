...
def create_model( image_height, image_width, channels, num_labels):
    ...
    model_CNN.add( 
        Conv2D( 32, (3, 3), activation="relu", padding="same", input_shape=( image_height, image_width, channels) )
    )
    ...
    # Disable 0% of the neurons in the layer at random during training. 
    #model_CNN.add(
    #    Dropout( 0 )
    #)
